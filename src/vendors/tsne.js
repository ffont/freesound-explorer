// Slightly edited version of karpathy's tsne.js
// https://github.com/karpathy/tsnejs

// create main global object
let tsnejs = tsnejs || { REVISION: 'ALPHA' };
    ...
    for (let i = 0; i < N; i++) {
      ...
      while (!done) {
        ...
        if (Hhere > Htarget) {
          ...
          if (betamax === Infinity) { beta *= 2; } else { beta = (beta + betamax) / 2; }
        } else {
          // converse case. make distrubtion less peaky
          betamax = beta;
          if (betamin === -Infinity) { beta /= 2; } else { beta = (beta + betamin) / 2; }
        }
